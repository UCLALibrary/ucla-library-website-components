...
const text = 'Napster mozy sococo orkut <a href=\'http://google.com/\'>convore scribd napster</a>, twones diigo joukuu weebly. <i>Sclipo jibjab scribd</i>.'
const textLong = 'Greplin prezi zillow zoosk orkut, zoosk gooru. Kiko xobni joukuu ideeli bitly joukuu, squidoo heroku hulu sifteo, zooomr jumo dropio chumby. Qeyno wikia oooooc jajah, ebay qeyno lala, jajah lijit. Etsy wufoo flickr movity sclipo heroku, oooooc etsy oooooc. Vimeo foodzie zoosk ebay, wesabe. Ebay doostang vuvox, xobni. Mozy joyent dropio gooru kippt, greplin skype. Kiko napster geni dogster yoono yammer disqus, hipmunk xobni odeo zynga loopt. Groupon klout divvyshot zinch elgg yoono airbnb, orkut zinch chartly squidoo.'
...
<template>
  ...
  <br>
  <br>
  <SiteNotificationAlert :title="title" :text="text" />
  <SiteNotificationAlert :title="title" :text="textLong" />
  <br>
  <br>
  ...
  <block-media-with-text :section-header="mockMediaWithText.mediaWithText[0].titleLink"
    ...
    :button-url="mockMediaWithText.mediaWithText[0].buttonUrl" :item="itemVideo" :coverImage="coverImage"
    type-media="video" />
  <br />
  <br />
</template>
