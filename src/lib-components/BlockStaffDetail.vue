...
import type { AcademicDepartmentsItemType, AlternativeNameItemType, DepartmentItemType, StaffLocationItemType, MediaItemType, TopicsItemType } from '@/types/types'
