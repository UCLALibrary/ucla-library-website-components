<template>
    <section :class="classes">
        <a :id="getId" v-if="sectionTitle" />
        {{ getId }}
        <div v-if="sectionTitle" class="section-header">
            <section-header v-if="sectionTitle" class="section-title" v-text="sectionTitle" />

            <rich-text v-if="sectionSummary" class="section-summary" v-html="sectionSummary" />
        </div>
