    ...
    <div class="media-with-text">
        <div class="text-grouping">
            ...
            <div class="meta-mobile">
                ...
                <div class="clippy">
                    ...
                    <svg-icon-play-filled v-if="isVideo || isAudio" class="icon-play-filled-mobile" />
                </div>
                <svg-icon-headphones v-if="isAudio" class="icon-headphones-mobile" />
            </div>
        ...
        <media-item v-if="item || coverImage" :item="item" :coverImage="coverImage" :coverOnly="true" class="meta media"
            ...
            <div class="clippy">
                ...
                <svg-icon-play-filled v-if="isVideo || isAudio" class="icon-play-filled" />
            </div>
            <svg-icon-headphones v-if="isAudio" class="icon-headphones" />
            <svg-icon-headphones v-if="isAudio" class="icon-headphones" />
        </media-item>
        <div v-if="!(item || coverImage)" class="no-media" />
        <NewLightbox v-if="showLightbox" :items="lightboxItems" @closeModal="showLightbox = false"
...
const parsedIsDownload = computed(() => {
    return props.buttonUrl && props.typeMedia === "other" ? true : false
}) 
</script>
