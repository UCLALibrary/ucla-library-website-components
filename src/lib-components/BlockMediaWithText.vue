    ...
    <div class="text-grouping">
      ...
      <div class="meta-mobile">
        ...
        <div class="clippy">
          ...
          <div v-if="isVideo || isAudio" class="clipped-play-mobile" />
          <SvgIconPlayFilled v-if="isVideo || isAudio" class="icon-play-filled-mobile" />
        </div>
        <SvgIconHeadphones v-if="isAudio" class="icon-headphones-mobile" />
      </div>
      <div v-if="shortDescription" class="short-description" v-html="shortDescription" />
      <ButtonLink
        v-if="buttonUrl" class="button" :to="buttonUrl" :label="buttonText" :is-secondary="true"
        :is-download="parsedIsDownload"
      />
    </div>
    <MediaItem
      v-if="item || coverImage" :item="item" :cover-image="coverImage" :cover-only="true" class="meta media"
      @click="showLightbox = true"
    >
      <div class="clippy">
        <div v-if="isVideo || isAudio" class="floating-highlight" />
        <div v-if="isVideo || isAudio" class="clipped-play" />
        <SvgIconPlayFilled v-if="isVideo || isAudio" class="icon-play-filled" />
      </div>
