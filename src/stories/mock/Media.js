...
export const VideoFile = [
    {
        id: "55785",
        src: "https://static.library.ucla.edu/craftassetstest/video/media-ammem-EdisonCompanies-4018.mp4",
        srcset: "",
        height: null,
        width: null,
        title: "Media ammem Edison Companies 4018",
        focalPoint: [0.5, 0.5],
        kind: "video",
        type: "video/mp4",
        alt: "video file short text",
    },
]
...
export const AudioFile = [
    {
        id: "46566",
        src: "https://static.library.ucla.edu/craftassetstest/audio/The-Sporting-Life-Queen-of-Sandcastles.mp3",
        srcset: "",
        height: null,
        width: null,
        title: "The Sporting Life Queen of Sandcastles",
        focalPoint: null,
        kind: "audio",
        type: "audio/mpeg",
        alt: "audio file alt text",
    },
]
...
export const AudioFileCoverImage = [
    {
        ...
        height: 2560,
        width: 2560,
        title: "Queen of Sandcastles",
        focalPoint: [0.5, 0.5],
        kind: "image",
        type: "image/jpeg",
        alt: "audio file cover alt text",
    },
]
...
export const AudioEmbedCoverImage = [
    {
        ...
        height: 2560,
        width: 2560,
        title: "The line of time and the plane of now",
        focalPoint: [0.5, 0.5],
        kind: "image",
        type: "image/jpeg",
        alt: "audio embed alt text",
    },
]
