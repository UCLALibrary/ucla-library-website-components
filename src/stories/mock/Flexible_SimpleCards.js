...
export const mockSixCards = {
  id: "20668",
  typeHandle: "simpleCards",
  sectionTitle: "Section Title - Flexible Simple Cards - Different Printing Methods Available",
  sectionSummary: "<p>Section Summary Let's explore seven of the most well-known and commonly used types; Offset Lithography, LED UV, Flexography, Digital Printing, Display Print, Screen Printing, 3D Printing.</p>\n<p><br /></p>",
  cards: [
    {
      id: "2870797",
