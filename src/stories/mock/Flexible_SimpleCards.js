...
export const mockTwoCards = {
  ...
  sectionTitle: "TWO Flexible Simple Cards - 2 Available Printing Methods ",
  sectionSummary: "<p><strong>Section Summary</strong> Let's explore <em>TWO</em> of the most well-known and commonly used types; Flexography and Digital Printing.</p>",
  cards: [
    {
      id: "2870799",
...
export const mockThreeCards = {
  id: '41058',
  typeHandle: 'simpleCards',
  sectionTitle: "THREE Flexible Simple Cards - 3 Available Printing Methods ",
  sectionSummary: "<p><strong>Section Summary</strong> Let's explore <em>THREE</em> of the most well-known and commonly used types; Flexography, Digital Printing, and Lithography.</p>",
  cards: [
    {
      id: "2870799",
      typeHandle: "externalServiceOrResource",
...
export const mockFourCards = {
  id: '41058',
  typeHandle: 'simpleCards',
  sectionTitle: "FOUR Flexible Simple Cards - 4 Available Printing Methods ",
  sectionSummary: "<p><strong>Section Summary</strong> Let's explore <em>FOUR</em> of the most well-known and commonly used types; Screen Printing, Flexography, Digital Printing, and Three Dimensional Printing.</p>",
  cards: [
    {
      id: "2870798",
      typeHandle: "externalServiceOrResource",
    ...
    //     {
    //       id: "2870963",
    //       uri: "visit/events-exhibitions/three-d-printing",
    //       slug: "three-d-printing",
    //       title: "3D Printing 02-27-24",
    //       summary: null
    //     }
    //   ]
    // },
...
export const mockFiveCards = {
  id: '41058',
  typeHandle: "simpleCards",
  sectionTitle: "FIVE Flexible Simple Cards - 5 Available Printing Methods ",
  sectionSummary: "<p><strong>Section Summary</strong> Let's explore <em>FIVE</em> of the most well-known and commonly used types; Lithography, Screen Printing, Flexography, Digital Printing,  and Three Dimensional Printing.</p>",
  cards: [
    {
      id: "2870797",
      typeHandle: "externalServiceOrResource",
