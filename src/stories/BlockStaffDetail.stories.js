...
const mock = {
    ...
    jobTitle: "Associate University Librarian for User Engagement (interim) and Director of Arts, Music and Powell Libraries",
    locations: [
    ...
    phone: "555-555-5555",
    departments: ["Digital Initiatives & Information Technology", "Software Development & Library Systems"],
    topics: [
