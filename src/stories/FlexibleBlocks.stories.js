...
const mockData = [
  ...
  },
  {
    ...
    sectionSummary:
            '<p><strong>Ombré</strong> (literally "shaded" in French) is the blending of one color <a href="https://en.wikipedia.org/wiki/Hue" title="Hue">hue</a> to another, usually moving <a href="https://en.wikipedia.org/wiki/Tints_and_shades" class="mw-redirect" title="Tints and shades">tints and shades</a> from light to dark.</p>',
    highlight: [
      {
        id: '58915',
        typeHandle: 'internalContent',
