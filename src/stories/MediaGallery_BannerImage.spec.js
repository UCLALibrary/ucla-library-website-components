describe("MEDIA GALLERY / Banner Image", () => {
    it("Default", () => {
        cy.visit(
            "/iframe.html?id=media-gallery-banner-image--default&args=&viewMode=story"
        )
    ...
    it("Expanded", () => {
        cy.visit(
            "/iframe.html?id=media-gallery-banner-image--expanded&args=&viewMode=story"
        )
        cy.get(".banner-image").should("exist")
    ...
    it("Single Item", () => {
        cy.visit(
            "/iframe.html?id=media-gallery-banner-image--single-item&args=&viewMode=story"
        )
        cy.get(".banner-image").should("exist")
