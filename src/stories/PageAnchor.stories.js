...
// <page-anchor v-bind="$props" color="visit" />
...
export default {
  ...
  argTypes: {
    sectionTitles: {
      ...
      description: 'h2 section-titles create page anchor links to respective sections',
      table: {
        type: {
...
Default.args = {
  sectionTitles: ['Using the Library', 'Services & Resources', 'Events & Exhibitions', 'About', 'News', 'Using the Library', 'Services & Resources', 'Events & Exhibitions', 'Contact a Subject Specialist', 'News', 'Featured Collection Items', 'Related News', 'More About Anything'],
  color: "default"
};
