...
<template>
  <div class="rich-text">
    <div v-if="textBlocks[0]" class="text" v-html="sanitizeHtml(textBlocks[0])" />
    <PullQuote
      v-if="pullQuote[0]" class="pull-quote" :text="pullQuote[0].text"
      :attribution="pullQuote[0].attribution"
    />
    <div v-if="textBlocks[1]" class="text" v-html="sanitizeHtml(textBlocks[1])" />
    <div v-if="images[0] && images[0].src" class="image-block">
      <ResponsiveImage class="image" :media="images[0]" :aspect-ratio="parsedRatio" />
      <div v-if="images[0].caption" class="caption" v-html="sanitizeHtml(images[0].caption)" />
    </div>

    <div v-if="textBlocks[2]" class="text" v-html="sanitizeHtml(textBlocks[2])" />
    <PullQuote
      v-if="pullQuote[1]" class="pull-quote" :text="pullQuote[1].text"
      :attribution="pullQuote[1].attribution"
    />
    <div v-if="textBlocks[3]" class="text" v-html="sanitizeHtml(textBlocks[3])" />
    <div v-if="images[1] && images[1].src" class="image-block">
      <ResponsiveImage class="image" :media="images[1]" :aspect-ratio="parsedRatio" />
      <div v-if="images[1].caption" class="caption" v-html="sanitizeHtml(images[1].caption)" />
    </div>

    <div v-if="textBlocks[4]" class="text" v-html="sanitizeHtml(textBlocks[4])" />
    <div v-if="textBlocks[5]" class="text" v-html="sanitizeHtml(textBlocks[5])" />
    <PullQuote
      v-if="pullQuote[2]" class="pull-quote" :text="pullQuote[2].text"
      :attribution="pullQuote[2].attribution"
    />
    <div v-if="textBlocks[6]" class="text" v-html="sanitizeHtml(textBlocks[6])" />
    <div v-if="images[2] && images[2].src" class="image-block">
      <ResponsiveImage class="image" :media="images[2]" :aspect-ratio="parsedRatio" />
      <div v-if="images[2].caption" class="caption" v-html="sanitizeHtml(images[2].caption)" />
    </div>
    <div v-if="textBlocks[7]" class="text" v-html="sanitizeHtml(textBlocks[7])" />
  </div>
</template>
