...
import SvgVmIcon from 'ucla-library-design-tokens/assets/svgs/icon-ftva-social_vimeo.svg'
...
@use "@/styles/default/_footer-primary.scss" as *;
@use "@/styles/ftva/_footer-primary.scss" as *;
</style>
