...
export const mockFTVABlogSeries = [
  {
    id: '3310088',
...
// example computed method to flatten the data, useful at page level when receiving craft cms data
export const parsedFTVABlogSeries = mockFTVABlogSeries.map((item) => {
  return {
    to: item.to,
    title: item.title,
