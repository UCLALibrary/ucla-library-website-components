...
// Mock data for GridAssetPod items
export const mockGridAssetPodItems = Array.from({ length: 12 }, (_, i) => ({
  media: {
    src: 'https://picsum.photos/400/300?random=' + (i + 1),
    alt: 'Digital Collection Item ' + (i + 1),
    width: 400,
    height: 300
  },
  to: '/asset/' + (i + 1),
  title: 'Digital Collection Item ' + (i + 1),
  ...
  metadata: {
    ...
    locations: ['Los Angeles Times Photographic Collection OpenUCLA Collections'],
  },
}))
...
// Mock data for BentoBoxResult component
export const mockBentoBoxResult = {
  title: 'Related Collections',
  items: [
    {
      to: '/collections/los-angeles-times',
      image: {
