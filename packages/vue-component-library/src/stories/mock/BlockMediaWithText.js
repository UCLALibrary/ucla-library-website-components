export const mock = {
  ...
  sectionTitle: 'sectionTitle: A section of media with text',
  ...
  mediaWithText: [
    {
      ...
      linkToMedia: 'https://uclalibrary.github.io/research-tips/assets/handouts/citation-integration-final.pdf',
      typeMedia: 'other',
    },
  ],
}
...
export const mockFTVA = {
  id: '13669',
  sectionTitle: 'FTVA Media with Text - Section Title',
  sectionSummary: '<p>Section Summary: A section of FTVA media with text</p>',
  mediaWithText: [
    {
      id: '13670',
