...
const longTextItems = [
  {
    ...
    description:
            'This is an example of a grid collection with an extremely long description. '.repeat(
              10
            ),
  },
  {
...
function Template(args: any) {
  return {
    ...
    template: `
      <grid-collections :items="args.items" />
    `,
  }
}
...
Default.args = { items: defaultItems }

export const LongText = Template.bind({})
LongText.args = { items: longTextItems }

export const NoTheme = TemplateNoTheme.bind({})
NoTheme.args = { items: defaultItems }
